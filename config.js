...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || '13_1_97c8_f013_05ee').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️,Maxi',
  ALWAYS_ONLINE: toBool(process.env.ALWAYS_ONLINE),
  LOG_MSG: toBool(process.env.LOG_MSG) || false,
  RMBG_KEY: process.env.RMBG_KEY || 'WaaMWiUcpWemzD8xTqfu8DiM',
